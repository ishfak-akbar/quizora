...
<style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .dots { position: absolute; display: grid; gap: 6px; }
    .dots span { width: 4px; height: 4px; border-radius: 50%; background: rgba(255,255,255,0.22); display: block; }
    .dots-tl { top: 60px; left: 40px; grid-template-columns: repeat(5,1fr); }
    .dots-bl { bottom: 120px; left: 260px; grid-template-columns: repeat(5,1fr); }
    ...
    .deco { position: absolute; color: rgba(255,255,255,0.28); font-size: 18px; font-weight: 200; }
    ...
    .input-wrap svg { flex-shrink: 0; opacity: 0.45; }
    .input-wrap input {
    flex: 1;
    height: 42px;
    ...
    .remember span { font-size: 13px; color: rgba(255,255,255,0.55); }
    .forgot {
    font-size: 13px; color: rgba(196,123,163,0.85);
    ...
    .card-footer a {
    color: #C47BA3; text-decoration: none;
...
<div class="auth-bg">
  ...
  <div class="el" style="top:320px;left:55px;flex-direction:column;gap:10px;align-items:flex-start;animation-delay:1s">
    <div style="display:flex;align-items:center;gap:10px;width:310px;height:46px;border:2px solid rgba(255,180,160,0.7);border-radius:24px;padding:0 16px;background:rgba(255,255,255,0.06)">
      ...
      <svg width="18" height="18" viewBox="0 0 18 18"><polyline points="3,9 7,13 15,5" fill="none" stroke="rgba(255,200,180,0.9)" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"/></svg>
    </div>
  ...
  <!-- 6. Big question orbit circle top-right -->
  ...
  <div class="login-card" style="position:relative">
    ...
    {{-- Session status (flash message e.g. password reset) --}}
@if (session('status'))
...
@csrf
    ...
    <div class="field">
        ...
        <div class="input-wrap">
            ...
            <input type="password" name="password" placeholder="Enter your password" id="passwordInput" required autocomplete="current-password"/>
